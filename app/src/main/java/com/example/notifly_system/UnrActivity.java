...
public class UnrActivity extends AppCompatActivity {
    ...
    // Notification list container (the LinearLayout inside the CardView)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // The LinearLayout inside the CardView that holds all rows
    ...
    private void loadNotifications() {
        ...
        notificationsRef.orderByChild("timestamp").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                // Collect all notifications into a list (newest first)
                List<DataSnapshot> notifList = new ArrayList<>();
                for (DataSnapshot child : snapshot.getChildren()) {
                    notifList.add(0, child); // insert at front to reverse order
                }
                ...
                // Render each notification as a row
    ...
    /**
     * Dynamically builds a notification row matching the XML design.
     * showDivider = true adds the separator line below the row.
     */
    private void addNotifRow(String title, String body, String date, boolean showDivider) {
        ...
        // ── TITLE + BODY (stacked in a vertical LinearLayout) ─────
        ...
        textBlock.setId(View.generateViewId());
